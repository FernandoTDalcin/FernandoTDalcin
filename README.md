# 🛡️ Fernando Tramontina Dalcin | Cybersecurity Student & Aspiring SOC Analyst

Entusiasta de Defesa Cibernética em transição de carreira, com foco em operações de **Blue Team**. Atualmente, dedico-me integralmente ao estudo de monitoramento, análise de incidentes e resposta a ameaças, buscando minha **primeira oportunidade no mercado de SOC**.
...
| :--- | :--- |
| **Defesa SOC** | Fundamentos de SIEM, Análise de Logs e Incident Response. |
| **Linha de Comando** | Operação em ambientes **Windows CLI (PowerShell/CMD)** e **Linux CLI (Bash)**. |
| **Infraestrutura** | Administração básica de **Active Directory (AD)** e Redes (TCP/IP). |
| **Ferramentas** | Prática com Wireshark, Nmap e ferramentas de laboratório. |

---

### 📊 Formação & Certificações

*   **Pós-graduação em Defensive Cyber Security** - FIAP (Out/2025 – Ago/2026).
*   **Graduação em Análise e Desenvolvimento de Sistemas** - UniCesumar.
*   **Networking Basics & Intro to Cybersecurity** - Cisco Networking Academy.
